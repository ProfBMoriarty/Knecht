...
PS.init = function( system, options ) {
	...
	// Use PS.gridSize( x, y ) to set the grid to the initial dimensions you want (32 x 32 maximum)
	// Do this FIRST to avoid problems!
	// Otherwise you will get the default 8x8 grid

	PS.gridSize( 8, 8 ); // replace with your own x/y values

	// Uncomment this line to inspect parameters
...
PS.input = function( sensors, options ) {
	...
	/*
	// Uncomment these line to inspect parameters
